...
### Documentation
- ✅ **Functional Requirements** (`../core/requirements.md`) - Complete specification
- ✅ **Platform Requirements** (`../reference/platform-requirements.md`) - Tech stack defined
- ✅ **UI Design** (`../core/UI-DESIGN.md`) - Directus-inspired design patterns
- ✅ **Database Schemas** (`../core/platform-db.sql`, `../core/tenant-db.sql`) - Complete schemas
- ✅ **Development Phases** (`../reference/development-phases-backend-frontend.md`) - Step-by-step roadmap
...
**See**: [Prisma Usage Explanation](../reference/prisma-usage-explanation.md) for details
...
**See**: [Project Structure](../reference/project-structure.md) for detailed structure
...
|----------|---------|--------------|
| [requirements.md](../core/requirements.md) | Functional requirements | Reference during development |
| [platform-requirements.md](../reference/platform-requirements.md) | Tech stack & versions | Before Phase 0 |
| [UI-DESIGN.md](../core/UI-DESIGN.md) | UI patterns & components | Before Phase 12 |
| [SETUP_GUIDE.md](./SETUP_GUIDE.md) | Complete setup guide | **Read this first** |
| [development-phases-backend-frontend.md](../reference/development-phases-backend-frontend.md) | Development roadmap | **Follow this for development** |
...
- **Requirements**: Check `../core/requirements.md`
- **Technology choices**: Check `../reference/platform-requirements.md`
- **Development steps**: Check `../reference/development-phases-backend-frontend.md`
- **Database structure**: Check `../core/platform-db.sql` and `../core/tenant-db.sql`
- **UI patterns**: Check `../core/UI-DESIGN.md`
